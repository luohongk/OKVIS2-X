...
describe('application routes', () => {
  ...
  it('highlights the active navigation item', () => {
    ...
    expect(screen.getByRole('link', { name: '数据运行' })).not.toHaveAttribute(
      'aria-current',
    )
  })

  it('redirects unknown routes to data run', () => {
    renderRoute('/does-not-exist')

    expect(screen.getByRole('heading', { name: '数据运行' })).toBeInTheDocument()
  })
